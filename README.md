...
2. **Kiểm tra công việc đang xử lý** (pending job):
   ...
   * Nếu **chưa có** trong danh sách → tự động thêm vào với mức lương = "N/A".
...
| CompanyName | Job Title | Link | Salary | Location | Page |
|-------------|-----------|------|--------|----------|------|
| Tên công ty | Tiêu đề công việc | Liên kết đến trang tuyển dụng | Mức lương | Địa điểm làm việc | Số trang |
